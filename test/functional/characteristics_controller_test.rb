...
class CharacteristicsControllerTest < ActionController::TestCase
  ...
  test "should create characteristic" do
    assert_difference('Characteristic.count') do
      post :create, characteristic: { descriptor_id: @characteristic.descriptor_id, instance_id: @characteristic.instance_id, value: @characteristic.value }
    end
  ...
  test "should update characteristic" do
    put :update, id: @characteristic, characteristic: { descriptor_id: @characteristic.descriptor_id, instance_id: @characteristic.instance_id, value: @characteristic.value }
    assert_redirected_to characteristic_path(assigns(:characteristic))
  end
